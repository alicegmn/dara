...
//   return (
//     <div className="player-container fixed bottom-2 left-1/2 transform -translate-x-1/2x p-6 flex self-center justify-center rounded-md border-4 border-black bg-colors-customGreen lg:right-2">
//       {currentTrack ? (
